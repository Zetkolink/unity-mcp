...
@mcp_for_unity_resource(
    ...
    description="Detailed information about currently selected objects in the editor, including selected GameObjects, assets, and IDs. Does not serialize full object properties.\n\nURI: mcpforunity://editor/selection"
)
